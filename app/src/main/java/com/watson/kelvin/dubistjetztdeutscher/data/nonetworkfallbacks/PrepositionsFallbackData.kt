...
object PrepositionsFallbackData {
    ...
    val genitivePrepositions = listOf(
        ...
        Preposition("mithilfe", "with the help of", "Mithilfe des Lehrers habe ich alles verstanden."), // new
        ...
        Preposition("zugunsten", "in favor of", "Das Geld wird zugunsten der Kinder gesammelt.") // new
    )
}