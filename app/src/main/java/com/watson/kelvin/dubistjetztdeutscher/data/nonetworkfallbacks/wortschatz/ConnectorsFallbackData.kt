...
object ConnectorsFallbackData {
    ...
    val subordinatingConjunctions = listOf(
        Connector(
            ...
            ConnectorCategory.SUBORDINATING
        ),
        ...
        Connector(
            ...
            ConnectorCategory.SUBORDINATING,
            "⚠️ Do not confuse with dazu / dafür (adverbial, V2)"
        ),
        Connector("dass", "that", "Ich denke, dass es regnet.", ConnectorCategory.SUBORDINATING),
        Connector(
            "falls",
            "in case",
            "Falls du kommst, bringst du Essen mit.",
            ConnectorCategory.SUBORDINATING
        ),
        Connector(
            "indem",
            "by doing",
            "Er lernt Deutsch, indem er viel liest.",
            ConnectorCategory.SUBORDINATING
        ),
        Connector(
            "nachdem",
        ...
        Connector(
            "seit / seitdem",
            "since",
            "Seit ich hier wohne, bin ich glücklich.",
            ConnectorCategory.SUBORDINATING
        ),
        Connector(
            "sobald",
        ...
        Connector(
            "solange",
            "as long as",
            "Solange du lernst, helfe ich dir.",
            ConnectorCategory.SUBORDINATING
        ), // new
        Connector(
            "während",
        ...
        Connector(
            "wenn",
            "when / if",
            "Wenn er müde ist, geht er nicht zum Sport.",
            ConnectorCategory.SUBORDINATING
        ),
        Connector(
            "weil",
    ...
    val adverbialConnectors = listOf(
        Connector(
            "allerdings",
            "however",
            "Ich mag Kaffee. Allerdings trinke ich lieber Tee.",
            ConnectorCategory.ADVERBIAL
        ), // new
        Connector(
            "anschließend",
            "subsequently",
            "Wir essen. Anschließend gehen wir spazieren.",
            ConnectorCategory.ADVERBIAL
        ), // new
        Connector(
            "außerdem",
        ...
        Connector(
            "dafür",
            "instead / in return",
            "Ich habe keine Zeit. Dafür habe ich morgen frei.",
            ConnectorCategory.ADVERBIAL
        ),
        Connector(
            "daher",
        ...
        Connector(
            "darüber hinaus",
            "moreover",
            "Er ist klug. Darüber hinaus ist er freundlich.",
            ConnectorCategory.ADVERBIAL
        ),
        Connector(
            "darum",
        ...
        Connector(
            "dazu",
            "in addition / while doing so",
            "Er kocht gern. Dazu hört er Musik.",
            ConnectorCategory.ADVERBIAL
        ),
        Connector(
            "deshalb",
        ...
        Connector(
            "folglich",
            "consequently",
            "Es regnet, folglich bleiben wir zu Hause.",
            ConnectorCategory.ADVERBIAL
        ), // new
        Connector(
            "inzwischen",
            "meanwhile",
            "Ich koche. Inzwischen deckt er den Tisch.",
            ConnectorCategory.ADVERBIAL
        ),
        Connector(
            "jedoch",
            "however",
            "Ich mag Kaffee. Jedoch trinke ich lieber Tee.",
            ConnectorCategory.ADVERBIAL
        ),
        Connector(
            "sonst",
    ...
    val nonConnectors = listOf(
        Connector(
            "nämlich",
            "namely / because",
            "Ich bleibe zu Hause. Es regnet nämlich.",
            ConnectorCategory.NON_CONNECTOR,
            "⚠️ Does NOT trigger inversion or verb movement"
        )
    )
}